<?php  //$this->user_model->info('ad_name');exit;?>
<form method="POST" action="<?=base_url('shops/email_share/'.$code.'/send')?>" class="form form-simple">
	<div class="row">
		...
		<div class="small-12 medium-9 columns">
			...
			<input type="text" required name="name" placeholder="Seu nome" value="">
		</div>
	</div>
	<div class="row">
		<div class="hide-for-small-only medium-2 columns">
